...
const rewrites = async () => {
  ...
  return [
    ...
    {
      source: '/api/rest/bus/getBusPosByRouteId/:routeId',
      destination: `http://ws.bus.go.kr/api/rest/buspos/getBusPosByRtid?serviceKey=${busstopKey}&busRouteId=:routeId&resultType=json`,
    },
  ];
};
